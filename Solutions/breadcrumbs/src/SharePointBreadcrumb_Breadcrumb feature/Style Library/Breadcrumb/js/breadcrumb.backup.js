    ...
    function getListTitle() {
        ...
        if (!breadcrumbProperties.hidePageLibraries) {
            if ((listTile == breadcrumbProperties.sitePagesLibrary) || (listTile == breadcrumbProperties.pagesLibrary)) {
                $('#breadcrumbSite li:last').before('<li class="ms-Breadcrumb-listItem"><a class="ms-Breadcrumb-itemLink" href="' + listUrl + '" title="' + listTile + '">' + listTile + '</a><i class="ms-Breadcrumb-chevron ms-Icon ms-Icon--ChevronRight"></i></li>');
            }
        }
    }
        ...
        if ($('#DeltaPlaceHolderPageTitleInTitleArea span span').length > 0 && (document.location.href).indexOf('RootFolder=') != -1) {
            ...
            $.each(libraryNodes, function (index, value) {
                ...
                if (value != "") {
                    ...
                    $('#breadcrumbSite').append('<li class="ms-Breadcrumb-listItem"><a class="ms-Breadcrumb-itemLink" href="' + libraryNodeURL + '" title="' + value + '">' + value + '</a><i class="ms-Breadcrumb-chevron ms-Icon ms-Icon--ChevronRight"></i></li>');
    ...
    function LoadSiteBreadcrumb() {
        ...
        clientcontext.executeQueryAsync(
            function () {
                ...
                var li = document.createElement('li');
                li.className = "ms-Breadcrumb-listItem";
                li.innerHTML = '<a class="ms-Breadcrumb-itemLink" href="' + currentWeb.get_url() + '" title="' + currentWeb.get_title() + '">' + currentWeb.get_title() + '</a><i class="ms-Breadcrumb-chevron ms-Icon ms-Icon--ChevronRight"></i>'
